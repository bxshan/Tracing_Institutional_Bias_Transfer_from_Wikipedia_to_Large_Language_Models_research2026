...
\citet{srivastava2024} show that applying differential privacy to corpora used in fine-tuning limits bias amplification.
...
We find that agreement is 43\% (13/30) exact / 80\% (24/30) within $\pm1$ on NELA-GT and 53\% / 100\% on NELA-PS (Table~\ref{tab:T1}); Cohen's $d$ \cite{cohen1988} $= 1.047$ between the NELA-GT and NELA-PS score distributions confirms the judge separates the corpora.
